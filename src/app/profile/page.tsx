  ...
  return (
    <div className="body_container">
        <div className="profile-hero-container">
            ...
            <div className="hero-profile">
                <div className="profile-image">
                    <img src="https://firebasestorage.googleapis.com/v0/b/promptbase.appspot.com/o/DALLE_IMAGES%2Fic5ASefHHEUQNeovrEKj0NqK5343%2Fresized%2F1680855838510_200x200.webp?alt=media&token=29379ebf-839f-4b1c-8371-e6fd0fdfd568" alt="" />
                </div>
        ...
        <div className="profile-description">
            <p>
            🏆 NEW BONUS: When you purchase this prompt, you will get a second ChatGPT Prompt Generator Prompt from us 🏆 The ONLY AI Prompts Broker you will ever need. 
            🦊 Best Prompts for Content Creators and Writers. 
            📚 Prompt Broker has everything you need to take your ideas to the next level. 
            🚀 DM & Get in touch with us to get you started 🔥
            </p>
            <span>
                <p>1.6k</p>
                <p>259</p>
            ...
            <p>Promptbroker Rank: <h5> #387</h5></p>
            <p>Joined: <h5> Apr 7, 2023</h5></p>
            <span>
                <h6>🦊 GPT</h6>
                <h6>🦊 GPT</h6>
                <h6>🦊 GPT</h6>
            ...
            <span>
                <p><h5>1807 </h5> Following</p>
                <p><h5>66 </h5> Followers</p>
            </span>
        </div>
        <div className="featured-prompt">
        <div className="featuredprompt-text">
        <h1>Most Popular Prompts by @promptbroker</h1>
        </div>
        ...
        <div className="featured-prompt">
        <div className="featuredprompt-text">
        <h1>Newest Prompts by @promptbroker</h1>
        </div>
        <div className="prompts-container">
          <div className="prompt">
